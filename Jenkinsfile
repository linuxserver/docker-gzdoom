pipeline {
  ...
  environment {
    ...
    EXT_USER = 'ZDoom'
    EXT_REPO = 'gzdoom'
    BUILD_VERSION_ARG = 'GZDOOM_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-gzdoom'
    CONTAINER_NAME = 'gzdoom'
    DOCKERHUB_IMAGE = 'linuxserver/gzdoom'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/gzdoom'
    PR_DOCKERHUB_IMAGE = 'lspipepr/gzdoom'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-gzdoom/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-gzdoom\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-gzdoom\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Gzdoom\" \
          --label \"org.opencontainers.image.description=[GZDoom](https://gzdoom.app/) is a feature centric port for all Doom engine games, based on ZDoom, adding an OpenGL renderer and powerful scripting capabilities.\" \
